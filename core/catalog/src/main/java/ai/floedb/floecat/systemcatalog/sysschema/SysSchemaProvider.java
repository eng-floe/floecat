...
/** Scanner provider for the {@code sys} schema runtime scanners. */
public final class SysSchemaProvider implements SystemObjectScannerProvider {
  ...
  public boolean supports(NameRef name, String engineKind) {
    ...
    if (name.getPathCount() != 1 || !SYS_SCHEMA.equalsIgnoreCase(name.getPath(0))) {
      return false;
    }
