...
- discovery within one configured Unity catalog, with its schemas mapped to root namespace paths;
...
The required `catalog` provider connection property selects the upstream Unity catalog. Other
