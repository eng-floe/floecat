...
- [`ExampleCatalogExtension.java`][example-catalog-extension-java] — config key constants and loading implementation
- [Bundled format-reference files][example-builtins-dir] — annotated PBtxt templates for every object type

[example-catalog-extension-java]: https://github.com/eng-floe/floecat/blob/main/extensions/example/src/main/java/ai/floedb/floecat/extensions/example/ExampleCatalogExtension.java
[example-builtins-dir]: https://github.com/eng-floe/floecat/tree/main/extensions/example/src/main/resources/builtins/example
