...
| `floecat.reconciler.worker-affinity` | Required, nonblank job-tree contract cohort shared by a control plane and its executor fleet (default `reconciler-v1`; blank prevents startup). |
