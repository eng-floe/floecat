...
| floecat.core.store.items | COUNTER | count | v1 | Count of items processed by store operations. | component, operation, result | account, component, exception, operation, result |
