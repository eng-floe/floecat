package ai.floedb.floecat.extensions.floedb.builtins;
...
class FloeBuiltinExtensionTest {
  ...
  void flaoDemoLoadsAndValidates() {
    var extension = new FloeBuiltinExtension.FloeDemo();
  ...
  void floeDbAndFloedemHaveSameStructure() {
    var floedb = new FloeBuiltinExtension.FloeDb();
    var floeDemo = new FloeBuiltinExtension.FloeDemo();

    BuiltinCatalogData floedbCatalog = floedb.loadBuiltinCatalog();
    BuiltinCatalogData flaoDemoCatalog = floeDemo.loadBuiltinCatalog();
  ...
  void loadBuiltinCatalogRoundtrips() {
    ...
    BuiltinCatalogData catalog1 = extension.loadBuiltinCatalog();
    BuiltinCatalogData catalog2 = extension.loadBuiltinCatalog();
  ...
  private static class TestExtensionWithMissingResource extends FloeBuiltinExtension {
    @Override
