...
public final class TableRequests {
  ...
  public record Rename(
      @NotNull @Valid IdentifierBody source, @NotNull @Valid IdentifierBody destination) {}

  public record IdentifierBody(@NotNull List<String> namespace, @NotBlank String name) {}
}
