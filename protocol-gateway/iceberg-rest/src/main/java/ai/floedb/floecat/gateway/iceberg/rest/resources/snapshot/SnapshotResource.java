...
import ai.floedb.floecat.gateway.iceberg.rest.api.dto.PartitionSpecDto;
import ai.floedb.floecat.gateway.iceberg.rest.api.dto.SnapshotDto;
import ai.floedb.floecat.gateway.iceberg.rest.api.dto.SnapshotsResponse;
import ai.floedb.floecat.gateway.iceberg.rest.api.request.SnapshotRequests;
...
public class SnapshotResource {
    ...
    var resp =
        stub.getSnapshot(
            GetSnapshotRequest.newBuilder()
                .setTableId(tableId)
                .setSnapshot(
                    ai.floedb.floecat.common.rpc.SnapshotRef.newBuilder().setSnapshotId(snapshotId))
                .build());
  ...
  private SnapshotDto toDto(ai.floedb.floecat.catalog.rpc.Snapshot snapshot) {
