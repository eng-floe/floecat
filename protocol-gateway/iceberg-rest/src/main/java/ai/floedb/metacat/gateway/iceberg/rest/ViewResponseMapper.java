...
final class ViewResponseMapper {
  ...
  static LoadViewResultDto toLoadResult(String namespacePath, String viewName, View view) {
    ...
    String metadataLocation =
        props.getOrDefault("metadata-location", props.getOrDefault("location", "metacat://" + viewName));
    Long timestamp =
        view.hasCreatedAt()
    ...
    ViewMetadataView.ViewRepresentation representation =
        new ViewMetadataView.ViewRepresentation("sql", view.getSql(), props.getOrDefault("dialect", "ansi"));
    ViewMetadataView.ViewVersion version =
        new ViewMetadataView.ViewVersion(
            ...
            namespace);
    ViewMetadataView.ViewHistoryEntry history =
        new ViewMetadataView.ViewHistoryEntry(0, timestamp);
