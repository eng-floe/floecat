...
class NamespacePropertyServiceTest {
  ...
  void updateRejectsReservedPropertyPrefixInUpdates() {
    Response response =
        service.updateProperties(
            namespaceContext(),
            null,
            new NamespaceRequests.Properties(List.of(), Map.of("polaris.internal", "x")));
  ...
  void updateRejectsReservedPropertyPrefixInRemovals() {
    Response response =
        service.updateProperties(
            namespaceContext(),
            null,
            new NamespaceRequests.Properties(List.of("polaris.internal"), Map.of()));
  ...
  void updateRejectsConflictingRemovalAndUpdateKeys() {
    Response response =
        service.updateProperties(
            namespaceContext(),
            null,
            new NamespaceRequests.Properties(List.of("owner"), Map.of("owner", "team-a")));
  ...
  void updateMergesPropertiesAndReportsUpdatedRemovedAndMissing() {
    ...
    NamespaceRequests.Properties request =
        new NamespaceRequests.Properties(List.of("region", "missing", "missing"), updates);
