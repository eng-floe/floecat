...
public final class RolePermissions {
  ...
  public static final String ACCOUNT_ASSIGNMENT_CONTROLLER_ROLE = "account-assignment-controller";
  ...
  public static final String ACCOUNT_ASSIGNMENT_CONTROL_INTERNAL =
      "account-assignment-control.internal";
  ...
  private static final List<String> ACCOUNT_ASSIGNMENT_CONTROLLER_PERMS =
      List.of(ACCOUNT_ASSIGNMENT_CONTROL_INTERNAL);
  ...
  public static List<String> permissionsForRoles(Collection<String> roles, boolean devMode) {
    ...
    for (String role : normalized) {
      ...
      switch (role) {
        ...
        case RECONCILE_WORKER_ROLE:
          ...
          break;
        case ACCOUNT_ASSIGNMENT_CONTROLLER_ROLE:
          perms.addAll(ACCOUNT_ASSIGNMENT_CONTROLLER_PERMS);
          break;
        default:
          break;
      }
    ...
    if (devMode) {
      ...
      perms.add(ACCOUNT_ASSIGNMENT_CONTROL_INTERNAL);
    }
    if (perms.isEmpty()) {
