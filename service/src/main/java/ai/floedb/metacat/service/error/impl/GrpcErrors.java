...
public final class GrpcErrors {
  ...
  public static StatusRuntimeException aborted(
    ...
    return build(io.grpc.Status.ABORTED, ErrorCode.MC_ABORT_RETRYABLE,
  ...
  public static StatusRuntimeException invalidArgument(
      ...
      String messageKey,
      Map<String, String> params) {
    return build(io.grpc.Status.INVALID_ARGUMENT, ErrorCode.MC_INVALID_ARGUMENT,
        correlationId, params, Map.of(), messageKey);
  }
  ...
  public static StatusRuntimeException notFound(
      ...
      String messageKey,
      Map<String, String> params) {
    return build(io.grpc.Status.NOT_FOUND, ErrorCode.MC_NOT_FOUND,
        correlationId, params, Map.of(), messageKey);
  }
  ...
  public static StatusRuntimeException conflict(
      ...
      String messageKey,
      Map<String, String> params) {
    return build(io.grpc.Status.ABORTED, ErrorCode.MC_CONFLICT,
        correlationId, params, Map.of(), messageKey);
  }
  ...
  public static StatusRuntimeException preconditionFailed(
      ...
      String messageKey,
      Map<String, String> params) {
    return build(io.grpc.Status.FAILED_PRECONDITION, ErrorCode.MC_PRECONDITION_FAILED,
        correlationId, params, Map.of(), messageKey);
  }
  ...
  public static StatusRuntimeException permissionDenied(
      ...
      String messageKey,
      Map<String, String> params) {
    return build(io.grpc.Status.PERMISSION_DENIED, ErrorCode.MC_PERMISSION_DENIED,
        correlationId, params, Map.of(), messageKey);
  }
  ...
  public static StatusRuntimeException rateLimited(
      ...
      String messageKey,
      Map<String, String> params) {
    return build(io.grpc.Status.RESOURCE_EXHAUSTED, ErrorCode.MC_RATE_LIMITED,
        correlationId, params, Map.of(), messageKey);
  }
  ...
  public static StatusRuntimeException timeout(
      ...
      String messageKey,
      Map<String, String> params) {
    return build(io.grpc.Status.DEADLINE_EXCEEDED, ErrorCode.MC_TIMEOUT,
        correlationId, params, Map.of(), messageKey);
  }
  ...
  public static StatusRuntimeException unavailable(
      ...
      String messageKey,
      Map<String, String> params) {
    return build(io.grpc.Status.UNAVAILABLE, ErrorCode.MC_UNAVAILABLE,
        correlationId, params, Map.of(), messageKey);
  }
  ...
  public static StatusRuntimeException cancelled(
      ...
      String messageKey,
      Map<String, String> params) {
    return build(io.grpc.Status.CANCELLED, ErrorCode.MC_CANCELLED,
        correlationId, params, Map.of(), messageKey);
  }
  ...
  public static StatusRuntimeException internal(
      ...
      String messageKey,
      Map<String, String> params) {
    return build(io.grpc.Status.INTERNAL, ErrorCode.MC_INTERNAL,
        correlationId, params, Map.of(), messageKey);
  }
  ...
  public static StatusRuntimeException snapshotExpired(
      ...
      String messageKey,
      Map<String, String> params) {
    return build(io.grpc.Status.FAILED_PRECONDITION, ErrorCode.MC_SNAPSHOT_EXPIRED,
        correlationId, params, Map.of(), messageKey);
  }
  ...
  public static StatusRuntimeException build(
    ...
    if (messageKey != null && !messageKey.isBlank()) {
      errorBuilder.setMessageKey(messageKey);
    }
