...
public final class GrpcErrors {
  ...
  public static StatusRuntimeException aborted(
      String correlationId, String messageKey, Map<String, String> params) {
    return build(
        io.grpc.Status.ABORTED,
        ErrorCode.MC_ABORT_RETRYABLE,
        correlationId,
        params,
        Map.of(),
        messageKey);
  ...
  public static StatusRuntimeException conflict(
      String correlationId, String messageKey, Map<String, String> params) {
    return build(
        io.grpc.Status.ABORTED, ErrorCode.MC_CONFLICT, correlationId, params, Map.of(), messageKey);
  }
