...
@IfBuildProperty(name = "metacat.kv.auto-create", stringValue = "true")
public class DynamoPointerTableBootstrap {
  ...
  @ConfigProperty(name = "metacat.kv.table")
  String table;

  @ConfigProperty(name = "metacat.kv.ttl-enabled", defaultValue = "true")
  boolean ttlEnabled;
