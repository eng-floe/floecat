...
/**
 * Session properties exposed by the Metacat connector. We define only what Iceberg needs to avoid
 * runtime errors when the Iceberg page source looks up catalog session properties.
 */
public class MetacatSessionProperties implements SessionPropertiesProvider {
  ...
  public static final String PARQUET_VECTORIZED_DECODING_ENABLED = "parquet_vectorized_decoding_enabled";
    ...
    properties =
        List.of(
            ...
            PropertyMetadataUtil.dataSizeProperty(
                ...
                false),
            booleanProperty(
                PARQUET_BATCH_READING_ENABLED,
                "Enable Parquet batch reading",
                true,
                false),
            ...
            booleanProperty(
                ...
                "Use Parquet bloom filter when available",
                true,
                false),
            booleanProperty(
